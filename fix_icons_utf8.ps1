...
# Define icons using double quotes and proper escaping if needed, or just insert them
# The issue with previous script was likely the encoding of the script file itself.
# We will construct new strings.
...
Write-Host "Replaced lines using index"
